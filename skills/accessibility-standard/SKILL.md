...
- Use when creating or reviewing web application code, especially UI components and interactions. Enforces WCAG 2.2 AA standards, ARIA best practices, and semantic HTML usage. Applies to React, Vue, Angular, Svelte, and any web framework.

- All UI code **must** follow these accessibility standards. This includes HTML structure, ARIA attributes, keyboard interactions, color contrast, and responsive design. Apply these rules consistently across all web projects to ensure accessibility for all users.
