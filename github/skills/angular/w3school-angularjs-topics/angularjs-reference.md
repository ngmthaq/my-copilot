...
> Source: https://www.w3schools.com/angularjs/angularjs_ref_directives.asp
...
| API                | Description                                         |
| ------------------ | --------------------------------------------------- |
| angular.fromJson() | Takes a JSON string and returns a JavaScript object |
...
| angular.element()   | Wraps an HTML element as a jQuery element            |
