...
| Dep Optimization Options    | https://vite.dev/config/dep-optimization-options  |
| SSR Options                 | https://vite.dev/config/ssr-options               |
| Worker Options              | https://vite.dev/config/worker-options            |
