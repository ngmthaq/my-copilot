---
name: javascript-convention
description: "JavaScript coding convention — covers general formatting rules, Prettier configuration, naming conventions, import organization, functions & arrow functions, object & array formatting, comments & documentation, EditorConfig, and ESLint key rules. This is the base convention for all JS/TS projects. Use when: formatting or refactoring JS/TS code; reviewing for style consistency; setting up Prettier/ESLint; applying naming conventions; organizing imports. DO NOT USE FOR: TypeScript-specific type rules (use typescript-convention); framework-specific conventions (use the framework convention sub-skill)."
---

# JavaScript Convention

This is the **base convention** for all JavaScript and TypeScript projects. Framework-specific conventions (React, Vue, Express, NestJS, React Native) extend this base.
