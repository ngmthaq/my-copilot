...
| Transformers.js | [transformersjs.md](transformersjs.md)   | Running models in browser/Node.js with @huggingface/transformers; JS pipeline API; WebGPU acceleration; ONNX Runtime Web; quantized models (q4/q8); Web Workers |
...
│   ├── In Python (text generation, classification, NER, QA)? → transformers.md
│   ├── In JavaScript/browser/Node.js?                        → transformersjs.md
