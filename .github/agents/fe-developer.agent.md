...
2. Load the relevant instruction file (reactjs, vuejs) and required skill files
...
- **React.js**: `.github/skills/reactjs/` — convention, design-component, modern-hook-mastery, state-management, routing-navigation, api-integration, form-handling-validation, ui-styling, performance-optimization
- **Vue.js**: `.github/skills/vuejs-composition-api/` — convention, design-component, modern-hook-mastery, state-management, routing-navigation, api-integration, form-handling-validation, ui-styling
- **TypeScript**: `.github/skills/typescript/`
