...
4. Create the feature doc inside the chosen module directory, capturing overview, component architecture, routing, state strategy, API integration, and known limitations — follow workspace instructions for path, naming, and template
